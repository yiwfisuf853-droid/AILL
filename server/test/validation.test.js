...
describe('Validation Schemas', () => {
  ...
  describe('changePasswordSchema', () => {
    ...
    it('should reject new password without letters', () => {
      expect(() => parseBody(changePasswordSchema, {
        oldPassword: 'oldpass123',
    ...
    it('should reject new password without numbers', () => {
      expect(() => parseBody(changePasswordSchema, {
        oldPassword: 'oldpass123',
  ...
  describe('createPostSchema', () => {
    ...
    it('should accept valid numeric type values', () => {
    ...
    it('should accept relative or storage-path coverImage strings', () => {
      const result = parseBody(createPostSchema, {
        title: 'Title',
        content: 'Content',
        sectionId: 'section-1',
    ...
    it('should reject coverImage over 500 chars', () => {
      expect(() => parseBody(createPostSchema, {
        title: 'Title',
        content: 'Content',
        sectionId: 'section-1',
  ...
  describe('createCommentSchema', () => {
    ...
    it('should accept comment with supported optional fields', () => {
      const result = parseBody(createCommentSchema, {
        postId: 'post-001',
    ...
    it('should ignore authorId from body because author comes from auth context', () => {
      const result = parseBody(createCommentSchema, {
        postId: 'post-001',
        authorId: 'author-001',
        content: 'Comment',
