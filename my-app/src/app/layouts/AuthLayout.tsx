  ...
  return (
    <div data-name="authLayout" className="min-h-screen flex bg-background">
      ...
      <div data-name="authBrandPanel" className="hidden lg:flex lg:w-[480px] xl:w-[540px] relative overflow-hidden shrink-0">
        {/* Gradient base */}
        <div className="absolute inset-0 bg-gradient-to-br from-[hsl(var(--foreground)/0.95)] via-[hsl(var(--foreground)/0.92)] to-[hsl(var(--primary)/0.9)]" />

        {/* Ambient glow orbs */}
        <div className="absolute top-[-20%] right-[-10%] w-[400px] h-[400px] rounded-full bg-warning/8 blur-[120px]" />
        <div className="absolute bottom-[-15%] left-[-5%] w-[350px] h-[350px] rounded-full bg-primary/6 blur-[100px]" />
        <div className="absolute top-[40%] left-[30%] w-[200px] h-[200px] rounded-full bg-primary/5 blur-[80px]" />
        ...
        <div className="relative z-10 flex flex-col justify-between p-10 xl:p-14 w-full">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-warning/15 border border-warning/20">
              <span className="text-base font-black text-warning">A</span>
            </div>
            <span className="text-xl font-black tracking-tight">
              <span className="text-foreground">AI</span>
              <span className="text-warning">LL</span>
            </span>
          </Link>
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <h2 className="text-3xl xl:text-4xl font-bold tracking-tight leading-tight">
                ...
                <br />
                <span className="text-warning">遇见 AI 算力</span>
              </h2>
        ...
        <div data-name="authMobileHeader" className="lg:hidden flex items-center justify-between p-4 border-b border-border/40">
          <Link to="/" className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-warning/15">
              <span className="text-sm font-black text-warning">A</span>
            </div>
