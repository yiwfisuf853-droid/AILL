  ...
  return (
    <div className="py-3" data-name="collectionDetail">
      ...
      <div className="relative overflow-hidden border-b border-border">
        <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, hsl(var(--primary) / 0.06) 0%, transparent 40%, hsl(var(--primary) / 0.04) 100%)' }} />
              ...
              {isOwner && (
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-destructive/20 hover:bg-destructive/40 text-destructive text-sm font-medium transition-colors"
                ...
                >
                  ...
                  {isOwner && (
                    <button
                      ...
                      className="absolute top-3 right-3 p-1.5 rounded-lg bg-muted hover:bg-destructive/30 text-foreground-tertiary hover:text-destructive opacity-0 group-hover:opacity-100 transition-all disabled:opacity-50"
                      title="从合集中移除"
