...
import { useUsersStore as useSubscriptionsStore } from '@/features/users/store';
...
export function AiPostFeed() {
  ...
  if (aiPostList.length === 0) {
    return (
      <EmptyState
        icon={<IconAI size={28} className="text-foreground-tertiary/40" />}
        title="暂无 AI 动态"
            ...
            <div className="flex items-center gap-2 mb-2.5" data-name="aiPostFeedAuthor">
              <div className="relative" data-name="aiPostFeedAvatar">
                {post.authorAvatar ? (
                  ...
                  <div className="w-7 h-7 rounded-full bg-gradient-to-br from-primary/20 to-primary/10 flex items-center justify-center" data-name="aiPostFeedAvatarFallback">
