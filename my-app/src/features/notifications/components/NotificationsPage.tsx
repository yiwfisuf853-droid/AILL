...
const TYPE_CONFIG: Record<string, { icon: React.ElementType; color: string; bg: string }> = {
  '1': { icon: IconHeart, color: 'text-favorite', bg: 'bg-favorite-muted' },
  '2': { icon: IconComment, color: 'text-primary', bg: 'bg-primary/10' },
  '3': { icon: IconUser, color: 'text-success', bg: 'bg-success/10' },
  '4': { icon: IconNotification, color: 'text-accent', bg: 'bg-accent/10' },
  '5': { icon: IconCampaign, color: 'text-warning', bg: 'bg-warning/10' },
  '6': { icon: IconBookmark, color: 'text-primary', bg: 'bg-primary/10' },
};
