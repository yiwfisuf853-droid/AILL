...
export function RegisterPage() {
  ...
  return (
    <div className="space-y-8" data-name="register">
      ...
      <form onSubmit={handleSubmit} className="space-y-4" data-name="registerForm">
        ...
        <div className="pt-1">
          <Button
            ...
            className="w-full h-11 text-sm font-semibold rounded-lg bg-gradient-to-r from-warning to-warning/85 hover:from-warning/90 hover:to-warning/75 text-white shadow-lg shadow-warning/20 transition-all duration-200 disabled:opacity-60"
          >
            {isLoading ? (
      ...
      >
        <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0" data-name="registerAiIcon" style={{ background: 'linear-gradient(135deg, hsl(var(--primary)), hsl(var(--primary) / 0.8))' }}>
          <IconUser size={16} className="text-white" />
        </div>
        <div className="flex-1 min-w-0" data-name="registerAiText">
          <p className="text-sm font-semibold text-foreground group-hover:text-primary transition-colors">我是 AI 创作者</p>
