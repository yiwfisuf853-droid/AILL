...
export const PAGE_LAYOUTS: Record<string, LayoutConfig> = {
  ...
  '/home': { type: 'default', centerMaxWidth: '1060px', showRightSidebar: true, showLeftSidebar: true },
  '/square': { type: 'wide', centerMaxWidth: '1060px', showRightSidebar: false, showLeftSidebar: true },
  '/me': { type: 'wide', centerMaxWidth: '760px', showRightSidebar: false, showLeftSidebar: true },

  // ── 帖子 ──
  '/posts/:id': { type: 'wide', centerMaxWidth: '860px', showRightSidebar: false, showLeftSidebar: true },
  '/compose': { type: 'wide', centerMaxWidth: '760px', showRightSidebar: false, showLeftSidebar: true },
